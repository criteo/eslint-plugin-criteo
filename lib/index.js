...
import pluginRxjsAngular from '@rxlint/eslint-plugin-angular';
...
const plugins = {
  ...
  '@rxlint': pluginRxjs,
  rxjs: pluginRxjs, // Define with previous alias for backward compatibility
  '@rxlint-angular': pluginRxjsAngular,
  'rxjs-angular': pluginRxjsAngular, // Define with previous alias for backward compatibility
